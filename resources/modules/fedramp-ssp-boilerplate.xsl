...
<!-- TBD: XSLT metadata
   ...
   <xsl:template mode="boilerplate" match="f:generate" expand-text="true">
      <xsl:variable name="warning">
         <xsl:text>BOILERPLATE NOT FOUND </xsl:text>
   ...
   <xsl:template mode="boilerplate" match="p//f:generate[@item] | td//f:generate[@item]" expand-text="true">
      <xsl:variable name="warning">
...
<!-- All the boilerplate follows. HTML contents appear in outputs.
   ...
   <xsl:template mode="boilerplate" match="f:generate[@section='1']">
         <section id="sec.1">
            ...
            <p>This System Security Plan provides an overview of the security requirements for the Information System Name (Enter Information System Abbreviation) and describes the controls in place or planned for implementation to provide a level of security appropriate for the information to be transmitted, processed or stored by the system.  Information security is vital to our critical infrastructure and its effective performance and protection is a key component of our national security program. Proper management of information technology systems is essential to ensure the confidentiality, integrity and availability of the data transmitted, processed or stored by the Enter Information System Abbreviation information system.</p>
            <p>The security safeguards implemented for the Enter Information System Abbreviation system meet the policy and control requirements set forth in this System Security Plan. All systems are subject to monitoring consistent with applicable laws, regulations, agency policies, procedures and practices.</p>
      ...
      <table class="uniform">
         <tr>
            <th>
               ...
               <p>(Use only information types from NIST SP 800-60, Volumes I and II as amended) </p>
            </th>
   ...
   <xsl:template mode="boilerplate" match="f:generate[@section='2.2']">
      <section id="sec.2.2">
         ...
         <p>Based on the information provided in <a href="#table.2-2">Table 2-2 Sensitivity Categorization of Information Types</a>, for the Enter Information System Abbreviation, default to the high-water mark for the Information Types as identified in <a href="#table.2-3">Table 2-3 Security Impact Level</a> below.</p>
         <f:generate table="2-3">Table 2-3. Security Impact Level</f:generate>
         <p>Through review and analysis, it has been determined that the baseline security categorization for the Enter Information System Abbreviation system is listed in the Table 24 Baseline Security Configuration that follows. </p>
         <f:generate table="2-4">Table 2-4. Baseline Security Configuration</f:generate>
         <p>Using this categorization, in conjunction with the risk assessment and any unique security requirements, we have established the security controls for this system, as detailed in this SSP.  </p></section>
   </xsl:template>
      ...
      <div id="table.2-3">
         ...
         <table class="uniform">
            ...
            <tr>
               ...
               <td><f:generate item="choose-level">confidentiality</f:generate></td>
            </tr>
            <tr>
               <td>Integrity</td>
               <td><f:generate item="choose-level">integrity</f:generate></td>
            </tr>
            <tr>
               <td>Availability</td>
               <td><f:generate item="choose-level">availability</f:generate></td>
            </tr>
         </table>
      </div>
   </xsl:template>
      ...
      <div id="table.2-3">
         ...
         <table class="uniform">
            <tr>
               ...
               <td><f:generate item="baseline-security-configuration"/></td>
            </tr>
         </table>
      </div>
   </xsl:template>
   ...
   <xsl:template mode="boilerplate" match="f:generate[@section='2.3']">
      <section id="sec.2.3">
         ...
         <p>The digital identity level is <span class="choice"><f:generate item="digital-identity-level"/></span>
            </p><p>Additional digital identity information can be found in Section 15 Attachments Digital Identity Level Selection.
         </p>
      </section>
   </xsl:template>
